...
// Првоерка на отмену ввода Пользователем
// if (userInput === null) {
//   console.log('Отменено пользователем!');
// }

// Перевод введенного значения пользователем в число
// let droidToBuy = Number(userInput);

// Проверка на то, что пользователь ввел число
// if (Number.isNaN(droidToBuy)) {
//   console.log('Пользователем введено не число. Введите, пожалуйста, число!');
// }

// const total = pricePerDroid * droidToBuy;

// if (total > credits) {
//   console.log('Недостаточно средств на счету!');
// } else if (total <= credits) {
//   credits = credits - total;
//   console.log(`Вы купили ${droidToBuy} дроидов, на счету осталось ${credits} кредитов.`);
// }
// !END Задание 4
...
// let userInput = prompt('Введите страну назначения').toLowerCase(); // Переводим в нижний регистр.
// let cost;
...
// console.log(`Доставка в ${userInput} будет стоить ${cost} кредитов`);
...
// не нужно. Если хочешь, в случае некорректного ввода, показывай alert с текстом
...
// Конвертируем строку promt-ввода в число
//   let inputToNumber = Number(input);

// Проверка на введнный тип данных
