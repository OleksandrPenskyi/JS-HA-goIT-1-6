...
// проведённое в одной игре для каждого игрока, и
// получить общую сумму этих времён.Рассчитать время
...
const totalAveragePlaytimePerGame = players.reduce((accu, player) => {
  return accu + player.playtime / player.gamesPlayed;
}, 0);
